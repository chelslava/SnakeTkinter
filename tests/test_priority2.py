...
from game_modes import GameMode, GameModeManager, PuzzleMode, SurvivalMode, TimeAttackMode
...
class TestNeuralSnakeAI(unittest.TestCase):
    ...
    def test_extract_features(self):
        ...
        features = self.neural_ai.extract_features(
    ...
    def test_get_safe_directions(self):
        ...
        safe_dirs = self.neural_ai.get_safe_directions(
            self.sample_snake, self.sample_food, self.sample_obstacles
        )
    ...
    def test_add_training_data(self):
        ...
        self.neural_ai.add_training_data(
            self.sample_snake, self.sample_food, self.sample_obstacles, "Right", 1.0
        )
...
class TestAdvancedGameAnalytics(unittest.TestCase):
    ...
    def test_record_move(self):
        ...
        self.analytics.record_move(
            self.sample_snake, self.sample_food, self.sample_obstacles, "Right", 5
        )
    ...
    def test_calculate_move_efficiency(self):
        ...
        efficiency = self.analytics.calculate_move_efficiency(
            self.sample_snake, self.sample_food, "Right"
        )
